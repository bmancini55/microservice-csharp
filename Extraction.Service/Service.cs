...
namespace MicroService.TextAndConcept
{
    public class Service
    {
        ...
        async Task<string> HandleConceptExtract(string file)
        {
            ...
            sw.Stop();
            //await app.Publish("log.cex", file + "|HandleConceptExtract|" + sw.ElapsedMilliseconds);
        ...
        async Task<string> HandleTextExtract(string file)
        {
            ...
            sw.Stop();
            //await app.Publish("log.cex", file + "|HandleTextExtract|" + sw.ElapsedMilliseconds);
        ...
        async Task<byte[]> ReadFileText(string file)
        {
            ...
            sw.Stop();
            //await app.Publish("log.cex", file + "|fileSize|" + length + "|ReadFileText|" + sw.ElapsedMilliseconds);
